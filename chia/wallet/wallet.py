...
from bitchia.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from bitchia.full_node.bundle_tools import simple_solution_generator
...
from bitchia.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from bitchia.wallet.puzzles.puzzle_utils import (
...
from bitchia.wallet.secret_key_store import SecretKeyStore
from bitchia.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_bitchia(self, bitchia_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if bitchia_amount < 0:
            utxos = await self.select_coins(abs(bitchia_amount), exclude)
        else:
        ...
        bitchia_amount = spend_value + bitchia_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": bitchia_amount}]
