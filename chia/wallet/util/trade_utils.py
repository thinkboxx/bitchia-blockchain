...
from bitchia.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "bitchia" in cc_discrepancies:
                    cc_discrepancies["bitchia"] = cc_discrepancies["bitchia"] + diff
                else:
                    cc_discrepancies["bitchia"] = diff
