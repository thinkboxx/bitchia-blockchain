...
from bitchia.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "bitchia/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "bitchia/wallet/puzzles/cc.clvm",
        "bitchia/wallet/puzzles/bitchialisp_deserialisation.clvm",
        "bitchia/wallet/puzzles/rom_bootstrap_generator.clvm",
        "bitchia/wallet/puzzles/generator_for_single_coin.clvm",
        "bitchia/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "bitchia/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "bitchia/wallet/puzzles/lock.inner.puzzle.clvm",
        "bitchia/wallet/puzzles/p2_conditions.clvm",
        "bitchia/wallet/puzzles/p2_delegated_conditions.clvm",
        "bitchia/wallet/puzzles/p2_delegated_puzzle.clvm",
        "bitchia/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "bitchia/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "bitchia/wallet/puzzles/p2_puzzle_hash.clvm",
        "bitchia/wallet/puzzles/rl_aggregation.clvm",
        "bitchia/wallet/puzzles/rl.clvm",
        "bitchia/wallet/puzzles/sha256tree_module.clvm",
        "bitchia/wallet/puzzles/singleton_top_layer.clvm",
        "bitchia/wallet/puzzles/did_innerpuz.clvm",
        "bitchia/wallet/puzzles/decompress_puzzle.clvm",
        "bitchia/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "bitchia/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "bitchia/wallet/puzzles/block_program_zero.clvm",
        "bitchia/wallet/puzzles/test_generator_deserialize.clvm",
        "bitchia/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["bitchia/wallet/puzzles/create-lock-puzzlehash.clvm", "bitchia/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "bitchia/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to bitchia/wallet/puzzles, but not added to `wallet_program_files`
        """
