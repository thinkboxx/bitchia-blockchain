...
from bitchia.cmds.init_funcs import bitchia_full_version_str
from bitchia.protocols.protocol_message_types import ProtocolMessageTypes
from bitchia.protocols.shared_protocol import Capability, Handshake
from bitchia.server.outbound_message import Message, NodeType, make_msg
from bitchia.server.rate_limits import RateLimiter
...
from bitchia.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from bitchia.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSBitChiaConnection:
    """
